...
<body>
    ...
    <section class="orders">
        <h1 class="title">قائمــةالطلبات</h1>
        <div class="box-container">
            ...
            <div class="box" style="text-align:right;" dir="rtl">
                <p>رقم المستخدم: <span><?php echo $fetch_orders['user_id']?></span></p>
                <p>تأريخ الطلب: <span><?php echo $fetch_orders['placed_on']?></span></p>
                ...
                <p>عدد الطلبات: <span><?php echo $fetch_orders['total_products']?></span></p>
                ...
                <form action="" method="post">
                    ...
                    <select name="update_payment">
                        ...
                        <option value="قيد التجهيز">طلب قيد التجهيز </option>
                        <option value="completed">طلبك مكتمل</option>
                    </select>
                    <input type="submit" value="update" name="update_order" class="option-btn">
                    <a href="admin_orders.php?delete=<?php echo $fetch_orders['id'];?>" 
                    onclick="return confirm('حذف هذا المنتج?');" class="delete-btn">حــذف</a>
                </form>
            </div>
            <?php
                }
            }else{
                echo '<p class="empty">لا يوجد لديك طلبات!</p>';
            }
            ?>
        </div>
    </section>
